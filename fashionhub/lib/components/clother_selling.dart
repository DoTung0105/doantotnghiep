...
class _CloSellingState extends State<CloSelling> {
  ...
  Widget build(BuildContext context) {
    ...
    String description = widget.cloSel.description.length > 170
        ? widget.cloSel.description.substring(0, 170) + '...'
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Price + Name
          Padding(
            padding: const EdgeInsets.only(left: 23.0, right: 3.0, bottom: 10),
            child: Row(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: 300,
                      child: Text(
                        widget.cloSel.name.length > 35
                            ? widget.cloSel.name.substring(0, 35) + '...'
                            : widget.cloSel.name,
